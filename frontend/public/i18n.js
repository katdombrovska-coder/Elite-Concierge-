...
(function() {
  ...
  const TRANSLATIONS = {
    ...
    ua: {
      ...
      'cta.sub': 'Приєднуйтесь до бізнесів, які скорочують витрати на обробку дзвінків на 80% — відповідаючи на кожен вхідний запит голосом і чатом, цілодобово, 31 мовою.',
      'cta.ctaStrategy': 'Замовити стратегічний дзвінок',
      'cta.ctaMessage': 'Написати нам',

      // ─── Founding Bottom ───
      'founding.bottomTitle': 'Ще тут? Пропозиція для перших клієнтів не вічна. Залишилось 3 місця.',
      'founding.bottomSub': 'Без зобовʼязань. Скасування в будь-який момент.',
